...
***************************************************************************** */
        ...
        function windowLoad() {
            collectionsElement = document.querySelector(".coloections");
            categoriesElements = document.querySelectorAll(".coloections__column");
            if (collectionsElement) loadProducts();
        }
        async function loadProducts(start = 0, limit = 3) {
            const productsJson = "files/json/colections.json";
        ...
        function documentActions(e) {
            const targetElement = e.target;
            if (targetElement.closest(".futer-coloections__button")) {
                const productsQuantity = document.querySelectorAll(".coloections__item").length;
        ...
        function addToCart() {
            ...
            const headerCartQuantity = document.querySelector("span");
